...
const QMetaObject ScenePlan::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_ScenePlan.data,
      qt_meta_data_ScenePlan,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScenePlan::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScenePlan.stringdata0))
        return static_cast<void*>(const_cast< ScenePlan*>(this));
